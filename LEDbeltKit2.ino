...
void loop() {
  ...
  flash(strip.Color(0,127,0), 100);
  scanner(127,0,0, 15);        // red, slow
  scanner(0,127,0, 15);        // blue, fast
  scanner(0,127,0, 15);        // blue, fast
  flash(strip.Color(127,0,0), 100);
  scanner(127,0,127, 15);        // magenta, fast
  scanner(127,0,127, 15);        // magenta, fast
  scanner(127,0,0, 15);        // red, fast
